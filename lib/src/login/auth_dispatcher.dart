...
/// 
/// It handles:
/// 1. Not Authenticated -> Student Dashboard (Bypass Login)
    ...
    return Consumer<AuthProvider>(
      builder: (context, auth, _) {
        ...
        if (!auth.isAuthenticated) {
          // If not authenticated, we now default to the Student Dashboard to bypass the removed Login Screen
          return StudentMainLayout();
        }
